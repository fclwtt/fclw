    ...
    else if($typeid == 999)
	{
		...
		if(!is_array($row))
		{
			...
			if(!empty($linkInfo)){
				...
				$revalue=<<<EOT
<li><a href='http://ad.dedecms.com' target='_blank' rel='nofollow' title='DedeCMS广告'>DedeCMS广告</a></li><li><a href='http://service.dedecms.com' rel='nofollow' target='_blank' title='织梦客户服务中心'>
织梦客户服务中心</a></li><li><a href='http://ask.dedecms.com' rel='nofollow' target='_blank' title='织梦问答'>
织梦问答</a></li><li><a href='http://tools.dedecms.com' target='_blank' rel='nofollow' title='站长工具'>
站长工具</a></li><li><a href='http://site.desdev.cn' target='_blank' rel='nofollow' title='DedeCMS建站中心'>
DedeCMS建站中心</a></li><li><a href='http://help.dedecms.com' rel='nofollow' target='_blank' title='织梦CMS帮助中心'>
...
EOT;
    ...
    while($dbrow=$dsql->GetObject())
    {
        ...
        {
            $link = "<a href='".$dbrow->url."' rel='nofollow' target='_blank'><img src='".$dbrow->logo."' width='88' height='31' border='0'></a> ";
        }
        else
        {
            if($dbrow->logo=='')
